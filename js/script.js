!(function(a) {
  ...
  a(document).ready(function() {
    ...
    function t() {
      var e = a(
        'input[type="search"], input[type="text"], input[type="url"], input[type="number"], input[type="email"], textarea'
      );
      e.each(function() {
        var e = a(this).val();
    ...
    function s() {
      ...
      e > n
        ...
        : (t
          ...
          i.next().css("margin-top", a(".header").height()),
          a(".bars, .bars-close, .logo-banner").hide(),
          a(".navigation .sub-menu").each(function() {
    ...
    function o() {
      ...
      e.length &&
        (n > 0
          ? n >= t
            ? i.length &&
              0 == i.hasClass("header-responsive") &&
              i.addClass("header-responsive")
            : (i.length &&
                1 == i.hasClass("header-responsive") &&
    ...
    function l() {
      a(".navigation .menu-parent").on("click", "> a", function(e) {
        ...
        t > i &&
          ...
          n.siblings(".sub-menu").slideToggle());
      });
    }
    function r() {
      var e = a(".dropdown-cn");
    ...
    function d() {
      a(".form-field .field-input")
        ...
        .on("keyup", function() {
          ...
          "" != e.val()
            ? 0 == n.hasClass("forcus") && n.addClass("focus")
            : n.removeClass("focus");
        });
    }
    function u() {
      a(".calendar-input,.caneldar").datepicker({
        ...
        a("#check-in").datepicker({
          ...
          onClose: function(e, n) {
            ...
            t.setDate(maxDate.getDate() + 1),
              a("#check-out").datepicker("option", "minDate", t);
          }
        }),
        a("#check-out").datepicker({
          ...
          onClose: function(e, n) {
            ...
            t.setDate(t.getDate() - 1),
              a("#check-in").datepicker("option", "maxDate", t);
          }
        });
    }
    function h() {
      a("#banner-slide").length > 0 &&
        a("#banner-slide").owlCarousel({
          autoPlay: 4e3,
          navigation: !1,
          pagination: !1,
          singleItem: !0,
          ...
          afterInit: function(e) {
            ...
            e.find(".owl-item").each(function(e, t) {
              var i = a(this)
                .find(".banner-slide-item")
                .data("src");
              a(this).css({ "background-image": "url(" + i + ")", height: n });
            });
          },
    ...
    function p() {
      e.any()
        ? (a(".banner-video-control").remove(), a("#banner-player").remove())
        : a("#banner-player").length &&
          (a("#banner-player").YTPlayer({
          ...
          a(".icon-play").click(function(e) {
            a(this).hasClass("fa-play")
              ? (a("#banner-player").YTPPlay(),
                a(this)
                  .removeClass("fa-play")
                  .addClass("fa-pause"))
              : (a("#banner-player").YTPPause(),
                a(this)
          ...
          create: function(e, n) {
            var t = a(this),
              i = a(this)
                ...
                .split(",");
            t.slider("values", i),
              t.prepend("<label class='label-min'>$" + i[0] + "</label>"),
              t.append("<label class='label-max'>$" + i[1] + "</label>");
          },
          slide: function(e, n) {
            var t = a(this),
              i = n.values;
            t.find(".label-min").text("$" + i[0]),
              t.find(".label-max").text("$" + i[1]),
              t.find(".range").attr("value", i);
          }
        });
    }
    function v() {
          ...
          create: function(e, n) {
            ...
            if (0 == isNaN(s)) {
              ...
              var l = Math.floor(s / 60),
                r = b(l, s - 60 * l, !0),
                c = b(o, i - 60 * o, !0);
              t.prepend("<label class='label-min'>" + c + "</label>"),
                t.append("<label class='label-max'>" + r + "</label>"),
                t.find(".range").attr("value", c + "," + r);
            } else {
              var c = b(o, i - 60 * o, !1);
              t.slider("value", i),
                t.slider("option", "range", "min"),
                t.append("<label class='label-max'>" + c + "</label>"),
                t.find(".range").attr("value", c);
            }
          },
          slide: function(e, n) {
            var t,
            ...
            1 == c
              ? ((t = n.values),
                ...
                (o = b(i, t[0] - 60 * i, !0)),
                (l = b(s, t[1] - 60 * s, !0)),
                r.find(".label-min").text(o),
                r.find(".label-max").text(l),
                r.find(".range").attr("value", o + "," + l))
              : ((t = n.value),
                (i = Math.floor(t / 60)),
                (o = b(i, t - 60 * i, !1)),
                r.find(".label-max").text(o),
                r.find(".range").attr("value", o));
          }
        });
    }
    function b(a, e, n) {
    ...
    function w() {
      a(".progress-rv").each(function(e, n) {
        var t = a(this).attr("data-value"),
          i = 10 * t;
        a(this).append(
          "<div style='width:" + i + "%'><span>" + t + "</span></div>"
        );
      });
    }
    function C() {
    ...
    function k() {
      a(".table-radio tbody tr").on("click", function() {
        var e = a(this);
        0 == e.hasClass("warning") &&
          (e
            .parents(".table-radio")
            .find(".warning")
            .removeClass("warning"),
          e.addClass("warning"),
          e.find(".radio").prop("checked", !0));
      });
    }
    function M() {
        ...
        a(".detail-cn").each(function(t, i) {
          ...
          a(".scroll-heading a").on("click", function() {
            ...
            return (
              a("html, body")
                .stop()
                .animate({ scrollTop: a(e).offset().top - 70 }, 1e3),
              !1
            );
          });
      }
    ...
    function T() {
      if (a("#hotel-maps").length) {
        ...
        var i,
          ...
          r = new google.maps.InfoWindow({ maxWidth: 600 }),
    ...
    function O() {
      a(".a-popup-room").length &&
        a(".a-popup-room").magnificPopup({
          type: "ajax",
          mainClass: "mfp-fade"
        });
    }
